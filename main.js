...
// Global function so your menu buttons can trigger it from the HTML onclick
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  if (checkoutBtn) {
    checkoutBtn.addEventListener("click", () => {
      ...
      // ⚠️ Replace with your actual Malaysian business WhatsApp number (include country code '60' without '+')
